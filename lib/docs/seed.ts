...
| \`type\` | string | \`ТипДокумента\` | Подстрока в имени типа, например \`ПриходныйКассовыйОрдер\` |
...
| \`account\` | string | \`СчетКасса\` | Подстрока в кассе или банковском счёте организации |
| \`responsible\` | string | \`Ответственный\` | Подстрока в ответственном |
| \`type\` | string | \`ТипДокумента\` | Подстрока в имени типа, например \`ПлатежноеПоручениеВходящее\` |
