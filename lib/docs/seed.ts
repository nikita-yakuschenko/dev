...
| Финансы | [заявки на расходование](/api/1c-upp/methods/payments-get), [ведомость по денежным средствам](/api/1c-upp/methods/cashflows-get) |
...
| Движения | [поступления](/api/1c-upp/methods/receipts-get), [перемещения](/api/1c-upp/methods/transfers-get), [требования-накладные](/api/1c-upp/methods/demands-get) |
...
- [Получить ведомость по денежным средствам](/api/1c-upp/methods/cashflows-get) — \`GET /main/hs/cashflows/get\`

## Поступления товаров и услуг

HTTP-сервис \`receipts\`:

- [Получить поступления товаров и услуг](/api/1c-upp/methods/receipts-get) — \`GET /main/hs/receipts/get\`
